...
function edit(id) {
  ...
  switch (type) {
    ...
    case 'type_radio': {
      ...
      w_attr_name = atrs[0];
      w_attr_value = atrs[1];
      type_radio(id, w_field_label, w_field_label_size, w_field_label_pos, w_field_option_pos, w_hide_label, w_flow, w_choices, w_choices_checked, w_rowcol, w_required, w_randomize, w_allow_other, w_allow_other_num, w_class, w_attr_name, w_attr_value, w_value_disabled, w_choices_value, w_choices_params);
      break;
    }
    ...
    case 'type_date_fields': {
      ...
      w_hide_label = document.getElementById(id + "_hide_labelform_id_temp").value;
      type_date_fields(id, w_field_label, w_field_label_size, w_field_label_pos, w_hide_label, w_day, w_month, w_year, w_day_type, w_month_type, w_year_type, w_day_label, w_month_label, w_year_label, w_day_size, w_month_size, w_year_size, w_required, w_class, w_from, w_to, w_divider, w_attr_name, w_attr_value);
      break;
    }
    case 'type_own_select': {
      ...
      w_attr_name = atrs[0];
      w_attr_value = atrs[1];
      type_own_select(id, w_field_label, w_field_label_size, w_field_label_pos, w_hide_label, w_size, w_choices, w_choices_checked, w_required, w_value_disabled, w_class, w_attr_name, w_attr_value, w_choices_disabled, w_choices_value, w_choices_params);
      break;
    }
...
function el_radio(subtype, new_id) {
  ...
  w_attr_name = [];
  w_attr_value = [];
  type_radio(new_id, 'Single Choice', '', 'top', 'right', 'no', 'ver', w_choices, w_choices_checked, '1', 'no', 'no', 'no', '0', '', w_attr_name, w_attr_value, 'no', w_choices_value, w_choices_params);
}
...
function create_upload_max_size(i, w_max_size) {
  ...
  var input = jQuery('<input type="text" class="fm-width-100" id="edit_for_max_size" onKeyPress="return check_isnum(event)" onChange="change_file_value(this.value,\'' + i + '_max_size\', \'***max_sizeskizb' + i + '***\', \'***max_sizeverj' + i + '***\')" value="' + w_max_size + '" />');
  return create_option_container(label, input);
}
...
function create_default_date(i, w_default_date) {
  ...
  var input = jQuery('<input class="fm-width-100" type="text" id="default_date" onChange="change_hidden_input_value(this.value, \'default_date\', ' + i + ', \'' + i + '_default_date_id_temp\')" value="' + w_default_date + '" />');
  return create_option_container(label, input);
}
...
function create_minimum_date(i, w_min_date, range) {
  ...
  var input = jQuery('<input class="fm-width-100" type="text" id="min_date" onChange="' + (range == true ? 'change_hidden_input_value_range(this.value, \'minDate\', \'start\', \'' + i + '\', \'' + i + '_min_date_id_temp\')' : 'change_hidden_input_value(this.value, \'minDate\', ' + i + ', \'' + i + '_min_date_id_temp\')') + '" value="' + w_min_date + '" />');
  return create_option_container(label, input);
}
...
function create_maximum_date(i, w_max_date, range) {
  ...
  var input = jQuery('<input class="fm-width-100" type="text" id="max_date" onChange="' + (range == true ? 'change_hidden_input_value_range(this.value, \'maxDate\', \'end\', ' + i + ', \'' + i + '_max_date_id_temp\')' : 'change_hidden_input_value(this.value, \'maxDate\', ' + i + ', \'' + i + '_max_date_id_temp\')') + '" value="' + w_max_date + '" />');
  return create_option_container(label, input);
}
...
function create_enable_options_value(i, w_value_disabled, type) {
...
function go_to_type_own_select(new_id) {
  ...
  w_attr_name = [];
  w_attr_value = [];
  type_own_select(new_id, 'Select', '', 'top', 'no', '', w_choices, w_choices_checked, 'no', 'no', 'wdform_select', w_attr_name, w_attr_value, w_choices_disabled, w_choices_value, w_choices_params);
}

function type_own_select(i, w_field_label, w_field_label_size, w_field_label_pos, w_hide_label, w_size, w_choices, w_choices_checked, w_required, w_value_disabled, w_class, w_attr_name, w_attr_value, w_choices_disabled, w_choices_value, w_choices_params) {
...
function type_radio(i, w_field_label, w_field_label_size, w_field_label_pos, w_field_option_pos, w_hide_label, w_flow, w_choices, w_choices_checked, w_rowcol, w_required, w_randomize, w_allow_other, w_allow_other_num, w_class, w_attr_name, w_attr_value,w_value_disabled, w_choices_value, w_choices_params ) {
...
function create_datefields_year_interval(i, w_from, w_to) {
  ...
  var input = jQuery('<input type="text" class="fm-width-40" id="edit_for_year_interval_from" onKeyPress="return check_isnum(event)" onKeyUp="year_interval(' + i + ')" value="' + w_from + '" />-<input type="text" class="fm-width-40" id="edit_for_year_interval_to" onKeyPress="return check_isnum(event)" onKeyUp="year_interval(' + i + ')" value="' + w_to + '" />');
  return create_option_container(label, input);
}
...
function go_to_type_date_fields(new_id) {
  ...
  type_date_fields(new_id, 'Date of Birth', '', 'top', 'no', '', '', '', 'SELECT', 'SELECT', 'SELECT', 'day', 'month', 'year', '60', '100', '80', 'no', 'wdform_date_fields', '1901', w_to, '&nbsp;/&nbsp;', w_attr_name, w_attr_value);
}

function type_date_fields(i, w_field_label, w_field_label_size, w_field_label_pos, w_hide_label, w_day, w_month, w_year, w_day_type, w_month_type, w_year_type, w_day_label, w_month_label, w_year_label, w_day_size, w_month_size, w_year_size, w_required, w_class, w_from, w_to, w_divider, w_attr_name, w_attr_value) {
...
function create_default_date_range(i, w_default_date_start, w_default_date_end) {
  ...
  var input = jQuery('<input type="text" class="fm-width-40" id="default_date_start" onKeyUp="change_hidden_input_value_range(this.value, \'default_date\', \'start\', ' + i + ', \'' + i + '_default_date_id_temp_start\')" value="' + w_default_date_start + '" />-<input type="text" class="fm-width-40" id="default_date_end" onKeyUp="change_hidden_input_value_range(this.value, \'default_date\', \'end\', ' + i + ', \'' + i + '_default_date_id_temp_end\')" value="' + w_default_date_end + '" />');
  return create_option_container(label, input);
}
